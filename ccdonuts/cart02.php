<?php include 'header.php';?>
  ...
  <li itemprop="itemListElement" itemscope
      itemtype="https://schema.org/ListItem">
    <a itemprop="item" href="cart02.php">
        <span itemprop="name">フルーツドーナツセット（12個入り）</span>
    </a>
...
<div class="㏄DoughnutImg">  
  <img src="images/shousai02/fruitDonut.png" alt="donutImg.png">
</div>

<div class="㏄Doughnut">
  <div><img src="images/shousai02/fruittitle.png" alt=""></div>
  <div><img src="images/shousai02/fruitText.png" alt=""></div>  
  <div class="price">
